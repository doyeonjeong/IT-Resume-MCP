const REASONING_TAG_BLOCKS = /<(?:thought|thinking|reasoning|scratchpad|reflection)>[\s\S]*?<\/(?:thought|thinking|reasoning|scratchpad|reflection)>/gi;
const UNCLOSED_REASONING_TAGS = /<(?:thought|thinking|reasoning|scratchpad|reflection)>[\s\S]*$/gi;
