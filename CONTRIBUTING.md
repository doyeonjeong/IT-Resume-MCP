...
3. Run `npm test -- --runInBand` and `npm run build` from the repo root
4. Update relevant docs (README, TESTING.md if behavior changes)
...
See `README.md` for build/test commands and `env.example` for required
